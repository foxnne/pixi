...
pub extern fn zip_entry_write(zip: ?*struct_zip_t, buf: ?*const c_void, bufsize: usize) c_int;
pub extern fn zip_entry_fwrite(zip: ?*struct_zip_t, filename: [*c]const u8) c_int;
pub extern fn zip_entry_read(zip: ?*struct_zip_t, buf: [*c]?*c_void, bufsize: [*c]usize) isize;
pub extern fn zip_entry_noallocread(zip: ?*struct_zip_t, buf: ?*c_void, bufsize: usize) isize;
pub extern fn zip_entry_fread(zip: ?*struct_zip_t, filename: [*c]const u8) c_int;
pub extern fn zip_entry_extract(zip: ?*struct_zip_t, on_extract: ?fn (?*c_void, c_ulonglong, ?*const c_void, usize) callconv(.C) usize, arg: ?*c_void) c_int;
...
pub extern fn zip_stream_extract(stream: [*c]const u8, size: usize, dir: [*c]const u8, on_extract: ?fn ([*c]const u8, ?*c_void) callconv(.C) c_int, arg: ?*c_void) c_int;
pub extern fn zip_stream_open(stream: [*c]const u8, size: usize, level: c_int, mode: u8) ?*struct_zip_t;
pub extern fn zip_stream_copy(zip: ?*struct_zip_t, buf: [*c]?*c_void, bufsize: [*c]usize) isize;
...
pub extern fn zip_extract(zipname: [*c]const u8, dir: [*c]const u8, on_extract_entry: ?fn ([*c]const u8, ?*c_void) callconv(.C) c_int, arg: ?*c_void) c_int;
