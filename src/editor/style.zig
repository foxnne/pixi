...
pub fn set(self: @This()) void {
    ...
    style.window_rounding = 8.0 * pixi.state.window.scale[0];
    style.popup_rounding = 8.0 * pixi.state.window.scale[0];
    style.tab_rounding = 8.0 * pixi.state.window.scale[0];
    style.frame_rounding = 8.0 * pixi.state.window.scale[0];
    style.grab_rounding = 4.0 * pixi.state.window.scale[0];
